...
function index()
	...
	local e=entry({"admin","nas","fileassistant"},template("fileassistant"),_("File Assistant"),1)
	e.dependent=true
	e.acl_depends={"luci-app-fileassistant"}
	entry({"admin","nas","fileassistant","list"},call("fileassistant_list")).leaf=true
	entry({"admin","nas","fileassistant","open"},call("fileassistant_open")).leaf=true
	entry({"admin","nas","fileassistant","delete"},call("fileassistant_delete")).leaf=true
	entry({"admin","nas","fileassistant","rename"},call("fileassistant_rename")).leaf=true
	entry({"admin","nas","fileassistant","upload"},call("fileassistant_upload")).leaf=true
	entry({"admin","nas","fileassistant","install"},call("fileassistant_install")).leaf=true
end
